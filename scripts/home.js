    ...
    .then(results => {
      ...
      results.forEach(r => {
        ...
        item.addEventListener('click', function() {
          ...
          if (searchMarker) {
            searchMarker.setLatLng([parseFloat(r.lat), parseFloat(r.lon)]);
          } else {
